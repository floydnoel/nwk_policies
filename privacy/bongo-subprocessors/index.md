---
title: Bongo Subprocessors
description: All the third-party subprocessors that we use to run Bongo.
---
...
We use third party subprocessors, such as cloud computing providers and customer support software, to run Bongo. We establish GDPR-compliant data processing agreements with each subprocessor, extending [GDPR safeguards](../index.md) everywhere personal data is processed.
