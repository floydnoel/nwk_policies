---
title: Logbook Subprocessors
description: All the third-party subprocessors that we use to run Logbook.
---

# Logbook subprocessors

*Last updated: July 18, 2022*

We use third party subprocessors, such as cloud computing providers and customer support software, to run Logbook. We establish GDPR-compliant data processing agreements with each subprocessor, extending [GDPR safeguards](../index.md) everywhere personal data is processed.
